            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 max-w-7xl">
                ...
                <div className="flex flex-col items-end text-right">
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-4 w-full">
                        ...
                        <img src="/images/inside_old3.png" alt="גלריה 5" className="w-full aspect-square object-cover rounded-md shadow-lg border-4 border-transparent transition-all duration-300 ease-in-out cursor-pointer hover:scale-105 hover:border-yellow-600" />
